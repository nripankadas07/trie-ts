        ...
        trie-ts exists to solve a narrow, inspectable developer-tooling problem:
        Type-safe Trie (prefix tree) with autocomplete, longest-prefix matching, deletion with leaf pruning, and lexicographic iteration.
        ...
        Topics: autocomplete, prefix-tree, trie, typescript, zero-dependencies
